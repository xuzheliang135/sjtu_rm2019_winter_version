...
void ArmorFinder::initCameraParam() {
    ...
    stereo_camera_param_.WIDTH = 640;
    stereo_camera_param_.HEIGHT = 480;
...
//    cout<<armor_box_left.tl()<<armor_box_right.tl()<<endl;
    ...
    space_position.x = space_position.z * (armor_box_left.x - stereo_camera_param_.WIDTH/2.) *
            stereo_camera_param_.LENGTH_PER_PIXAL / stereo_camera_param_.FOCUS;
    space_position.y = space_position.z * (armor_box_left.y - stereo_camera_param_.HEIGHT/2.) *
            stereo_camera_param_.LENGTH_PER_PIXAL / stereo_camera_param_.FOCUS;
    double x_right = space_position.z * (armor_box_right.x - stereo_camera_param_.WIDTH/2.) *
                                        stereo_camera_param_.LENGTH_PER_PIXAL / stereo_camera_param_.FOCUS;
    double y_right = space_position.z * (armor_box_right.y - stereo_camera_param_.HEIGHT/2.) *
                     stereo_camera_param_.LENGTH_PER_PIXAL / stereo_camera_param_.FOCUS;
